			...
			<div class="col-sm-3 pt-4">
				<div class="card border border-info" style="background-color: white;">
					<div class="card-body text-center">
						...
						<p>---------------------------------------------</p>
						<p class="card-text">Manage all the employees here.</p>
			...
			<div class="col-sm-3 pt-4">
				<div class="card border border-info" style="background-color: white;">
					<div class="card-body text-center">
						...
						<p>---------------------------------------------</p>
						<p class="card-text">Manage chat here.</p>
						<a href="/admin/chat" class="card-link btn btn-primary">Manage</a>
			...
			<div class="col-sm-3 pt-4">
				<div class="card border border-info" style="background-color: white;">
					<div class="card-body text-center">
						...
						<p>---------------------------------------------</p>
						<p class="card-text">Manage inventory of each branch here.</p>
						<a href="/admin/inventory" class="card-link btn btn-primary">Manage</a>
			...
			<div class="col-sm-3 pt-4">
				<div class="card border border-info" style="background-color: white;">
					<div class="card-body text-center">
						...
						<p>---------------------------------------------</p>
						<p class="card-text">Manage sales statistics here.</p>
						<a href="/admin/stats" class="card-link btn btn-primary">Manage</a>
